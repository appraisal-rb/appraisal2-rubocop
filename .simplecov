# kettle-jem:freeze
# To retain chunks of comments & code during appraisal2-rubocop templating:
# Wrap custom sections with freeze markers (e.g., as above and below this comment chunk).
# appraisal2-rubocop will then preserve content between those markers across template runs.
# kettle-jem:unfreeze
