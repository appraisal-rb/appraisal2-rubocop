...
Gem::Specification.new do |spec|
  ...
  spec.metadata["homepage_uri"] = "https://appraisal2-rubocop.galtzo.com"
  ...
  # Utilities
  spec.add_dependency("appraisal2", ">= 3.1.1")
  ...
  spec.add_development_dependency("kettle-dev", "~> 2.2", ">= 2.2.13")     # ruby >= 3.1.0
  ...
  # Testing
  spec.add_development_dependency("kettle-test", "~> 2.0", ">= 2.0.5")             # ruby >= 3.1.0
  ...
  # The 'git' gem is optional; appraisal2-rubocop falls back to shelling out to `git` if it is not present.
