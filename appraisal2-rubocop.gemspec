...
Gem::Specification.new do |spec|
  ...
  # Utilities
  spec.add_dependency("appraisal2", ">= 3.2.4")
  ...
  spec.add_development_dependency("kettle-dev", "~> 3.1", ">= 3.1.1")             # ruby >= 3.1.0
  ...
  spec.add_development_dependency("kettle-test", "~> 2.0", ">= 2.0.22")            # ruby >= 3.1.0
